...
urlpatterns = [
    ...
    path('select-venue-tier/', views.select_venue_tier, name='select_venue_tier'),
    path('customization-summary/<int:booking_id>/', views.customization_summary, name='customization_summary'),
    # Remove or update the following line since select_venue is not defined:
    # path('select-venue/', views.select_venue, name='select_venue'),
]
